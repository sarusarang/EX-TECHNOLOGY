...
function ContactUs() {
    ...
    return (
        ...
        <>
            ...
            <section className='container p-3 pt-5 mt-5 mb-5 contact' style={{ borderTop: '1px solid #e8e5e5' }}>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 pt-4" data-aos="fade-left" data-aos-duration="400">


                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3720.4421418201214!2d75.85261257481112!3d11.179565288994771!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba651be1190a97d%3A0xbde6ecee8d0fdb1c!2sKINFRA%20Advanced%20Technology%20Park%2C%20Ramanattukara!5e1!3m2!1sen!2sin!4v1722576935488!5m2!1sen!2sin" width="100%" height="280" style={{border:'0'}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
